...
def ventana_carmelo(parent):
    ...
    ttk.Label(box1, text="Tabla P/ De Carmelo", font=("Arial", 25, "bold"), background='#192965', foreground='white').grid(row=0, column=0, sticky="w", pady=15)
    ...
    box3 = tk.Frame(frame, background= '#192965')
    box3.grid(row=0, column=1 , padx=30)
    ...
    tk.Button(carmelo_frame, text="Enviar", bg="blue",fg="white", command=lambda: mandar_piezas_a("pulidor_carmelo", cantida_de_piezas_c, piezas_seleccionada_c, mostrar_piezas, historial)).grid(row=3, column=0, columnspan=2, pady=5)
    ...
    tk.Button(carmelo_frame, text="Recibir",bg="green",fg="white", command=lambda: resicbir_piezas_de("pulidor_carmelo", cantida_de_resibida_c, piezas_resibida_c, mostrar_piezas, historial)).grid(row=7, column=0, columnspan=2, pady=5)

    # Stock para Carmelo
    tk.Label(carmelo_frame, text="Stock Carmelo",font=("Arial", 8,"bold" ,"underline")).grid(row=8, column=0, pady=(10, 0))
    tk.Button(carmelo_frame, text="EN CARMELO", command=lambda: mostrar_categoria(mostrar_piezas, info_pieza, piezas , imagen_piezas, query_carmelo, "pulidor_carmelo")).grid(row=9, column=0, pady=5)
