...
def verificar_stock_maquinas(piezas_total_pintada, cantidad_maquinas):
    ...
    print(f"Tienes suficiente stock para armar {cantidad_maquinas} máquinas.")
    return True
