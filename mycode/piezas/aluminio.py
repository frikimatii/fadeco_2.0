...
def aluminio(parent):
    ...
    ttk.Label(box1, text="Tabla con piezas de aluminio", font=("Arial", 15, "bold"), background="#192965" , foreground='white').grid(row=0, column=0, sticky="w", pady=15)
    ...
    tk.Label(box2, text="Aluminio", font=("Arial", 30, "bold"), background="#192965" , foreground='white').grid(row=0, column=0)
    tk.Label(box2,fg="#535c68", text="Mostrar todas las piezas de aluminio y  seleccionar una pieza de la tabla", font=("Arial", 12, "bold"), wraplength=300, background="#192965" , foreground='white').grid(row=1, column=0)
    ...
    btn_agregar = tk.Button(box_btn, width=10, text="eliminar", font=("Arial", 14, "bold"), bg="red", fg="white",command=lambda: eliminar_piezas(pieza_seleccionada, entry_cantidad_piezas, mostrar_piezas, historial, "Aluminio", "piezas_brutas"))
