...
def chapa(parent):
    ...
    tk.Button(box2, text="Mostras Piezas de Chapa", command= lambda: mostrar_categoria(mostrar_piezas, "Chapa", "piezas_brutas", detalles_pieazas, pieza_seleccionada)).grid(row=1, column=0)
    ...
    btn_agregar = ttk.Button(box_btn, text="Agregar" ,command=lambda: agregar_piezas(pieza_seleccionada, entry_cantidad_piezas, mostrar_piezas, hisotrial, "Chapa", "piezas_brutas"))
