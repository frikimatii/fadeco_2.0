...
def plastico(parent):
    ...
    tk.Label(box2, text="Plastico - inyector", font=("Arial", 30, "bold")).grid(row=0, column=0)
    ...
    tk.Button(box2, text="Mostras Piezas", padx=20, pady=5, font=("Arial", 14, "bold"), bg="blue", fg="white",  command= lambda: mostrar_categoria(mostrar_piezas, "Plastico", "piezas_brutas", detalles_piezas, pieza_seleccionada, imagen_piezas)).grid(row=2, column=0)
    ...
    btn_agregar = tk.Button(box_btn, width=30, text="Agregar" , font=("Arial", 14, "bold"), bg="green", fg="white", command=lambda: agregar_piezas(pieza_seleccionada, entry_cantidad_piezas, mostrar_piezas, historial, "Plastico", "piezas_brutas"))
