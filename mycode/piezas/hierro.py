...
def hierro(parent):
    ...
    tk.Label(box2, text="Fundición de Hierro", font=("Arial", 30, "bold"), background="#192965", foreground='white').grid(row=0, column=0)
    tk.Label(box2, fg="#535c68", text="Mostrar todas las piezas de hierro y seleccionar una pieza de la tabla", font=("Arial", 12, "bold"), wraplength=300, background="#192965", foreground='white').grid(row=1, column=0)

    tk.Button(box2, text="Mostrar Piezas de fundición de hierro", padx=20, pady=5, font=("Arial", 14, "bold"), bg="blue", fg="white", command=lambda: mostrar_categoria(mostrar_piezas, "Hierro", "piezas_brutas", detalles_piezas, pieza_seleccionada, imagen_piezas)).grid(row=2, column=0)
    ...
    box_acciones.grid(row=4, column=0)
    ...
    btn_agregar = tk.Button(box_btn, width=10, text="Agregar", font=("Arial", 14, "bold"), bg="green", fg="white", command=lambda: agregar_piezas(pieza_seleccionada, entry_cantidad_piezas, mostrar_piezas, historial, "Hierro", "piezas_brutas"))
    btn_agregar.grid(row=0, column=1, pady=10, padx=5)

    btn_eliminar = tk.Button(box_btn, width=10, text="Eliminar", font=("Arial", 14, "bold"), bg="red", fg="white", command=lambda: eliminar_piezas(pieza_seleccionada, entry_cantidad_piezas, mostrar_piezas, historial, "Hierro", "piezas_brutas"))
