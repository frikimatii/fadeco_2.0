...
def hierro(parent):
    ...
    ttk.Label(box1, text="Tabla de piezas", font=("Arial", 15, "bold")).grid(row=0, column=0, sticky="w", pady=15)
    ...
    tk.Label(box2, text="Fundicion de Hierro", font=("Arial", 30, "bold")).grid(row=0, column=0)
    ...
    tk.Button(box2, text="Mostras Piezas de fundicion de hierro", padx=20, pady=5, font=("Arial", 14, "bold"), bg="blue", fg="white", command= lambda: mostrar_categoria(mostrar_piezas, "Hierro", "piezas_brutas", detalles_piezas, pieza_seleccionada, imagen_piezas)).grid(row=2, column=0)
