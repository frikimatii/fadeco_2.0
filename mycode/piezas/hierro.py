...
def hierro(parent):
    ...
    btn_agregar = tk.Button(box_btn, width=30, text="Agregar" , font=("Arial", 14, "bold"), bg="green", fg="white",command=lambda: agregar_piezas(pieza_seleccionada, entry_cantidad_piezas, mostrar_piezas, historial, "Hierro", "piezas_brutas"))
