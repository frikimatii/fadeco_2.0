...
def shop(parent):
    ...
    ttk.Label(box1, text="Tabla con piezas Compradas",font=("Arial", 15, "bold")).grid(row=0, column=0, sticky="w", pady=15)
    ...
    tk.Label(box2, text="Compras", font=("Arial", 30, "bold")).grid(row=0, column=0)
    tk.Label(box2,fg="#535c68", text="Mostrar todas las piezas de que se compran  y seleccionar una pieza de la tabla", font=("Arial", 12, "bold"), wraplength=300).grid(row=1, column=0)

    tk.Button(box2, text="Mostras Piezas", padx=20, pady=5, font=("Arial", 14, "bold"), bg="blue", fg="white", command= lambda: mostrar_categoria(mostrar_piezas, "shop", "piezas_brutas", detalles_piezas, pieza_seleccionada, imagen_piezas)).grid(row=2, column=0)
