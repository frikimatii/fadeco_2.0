...
def shop(parent):
    ...
    tk.Label(box2,fg="#535c68", text="Mostrar todas las piezas de que se compran  y seleccionar una pieza de la tabla", font=("Arial", 12, "bold")).grid(row=1, column=0)
    ...
    btn_agregar = tk.Button(box_btn, width=30, text="Agregar", font=("Arial", 14, "bold"), bg="green", fg="white", command=lambda: agregar_piezas(pieza_seleccionada, entry_cantidad_piezas, mostrar_piezas, historial, "shop", "piezas_brutas"))
