...
def tornillo(parent):
    ...
    tk.Label(box2, text="Chapa").grid(row=0, column=0)

    tk.Button(box2, text="Mostras Piezas de tornilleria", command= lambda: mostrar_categoria(mostrar_piezas, "Tornilleria", "piezas_brutas", detalles_pieazas, pieza_seleccionada)).grid(row=1, column=0)
    ...
    btn_agregar = ttk.Button(box_btn, text="Agregar" ,command=lambda: agregar_piezas(pieza_seleccionada, entry_cantidad_piezas, mostrar_piezas, hisotrial, "Tornilleria", "piezas_brutas"))
